...
export function BottomNavigation() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border medical-card-shadow z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom, 0px)' }}>
