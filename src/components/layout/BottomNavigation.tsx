...
export function BottomNavigation() {
  ...
  return (
    <nav className="ios-fixed-bottom bg-card border-t border-border medical-card-shadow ios-nav-height flex flex-col">
      <div className="relative flex items-center h-14 sm:h-16 px-3 sm:px-4 flex-1">
      ...
      <div className="ios-home-indicator-aware" />
    </nav>
  );
}