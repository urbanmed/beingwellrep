...
export function ReportTimelineView({ 
  reports, 
  selectedReports, 
  onSelectReport, 
  onNavigateToReport, 
  onNavigateToUpload 
}: ReportTimelineViewProps) {
      ...
      {Object.keys(groupedByDate).length > 0 ? (
        <div className="relative">
          ...
          <div className="space-y-8">
            {Object.entries(groupedByDate).map(([dateKey, dayReports]) => {
                ...
                <div key={dateKey} className="relative">
                  ...
                  <div className="flex items-center mb-4">
                    <div className="relative z-10 bg-background pr-4">
                      <h3 className="medical-subheading text-muted-foreground">
                        {dateLabel}
                      </h3>
                    </div>
